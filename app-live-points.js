/* OTB 2026.09.07.1 — Review snapshot integrity, same-club role continuity, import-specific official chip availability, rolling low-owned signal persistence, rule-aware Review scoring, source-hash revalidation,
...
(function loadOtbCore(){
  ...
  script.src='app-core.js?v=2026.09.07.1-core';
  script.async=false;
  script.onload=()=>{
...
function installOtbLivePointsPatch(){
  ...
  const badge=document.getElementById('buildBadge');if(badge){badge.textContent='BUILD 09.07.1';badge.title='OTB responsive role updates + exact player rankings + Review integrity';}
