/* OTB 2026.08.29.4 — import-specific official chip availability, rolling low-owned signal persistence, rule-aware Review scoring, source-hash revalidation,
...
(function loadOtbCore(){
  ...
  script.src='app-core.js?v=2026.08.29.4-core';
  script.async=false;
  script.onload=()=>{
...
function installOtbLivePointsPatch(){
  ...
  const badge=document.getElementById('buildBadge');if(badge){badge.textContent='BUILD 08.29.4';badge.title='OTB Optimize XI + verified deadline regime + official chip-history availability + rule-aware Gameweek Review + live GW scoring';}
