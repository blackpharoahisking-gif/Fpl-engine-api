/* OTB 2026.08.29.1 — import-specific official chip availability, rolling low-owned signal persistence, rule-aware Review scoring, source-hash revalidation,
...
(function loadOtbCore(){
  ...
  script.src='app-core.js?v=2026.08.29.1-core';
  script.async=false;
  script.onload=()=>{
