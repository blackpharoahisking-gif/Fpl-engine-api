...
test('production loader preserves live scoring and keeps legacy D1 accountability available downstream', async () => {
  ...
  assert.match(loader, /app-live-points\.js\?v=2026\.09\.07\.1-live/);
  ...
  assert.match(live, /OTB 2026\.09\.07\.1/);
  assert.match(live, /script\.src='app-core\.js\?v=2026\.09\.07\.1-core'/);
});
