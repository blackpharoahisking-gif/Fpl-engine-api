/* OTB 2026.09.07.1 — Responsive role updates and player ranking setup.
...
(function loadOtbProductionLayers(){
  ...
  const badge=document.getElementById('buildBadge');if(badge)badge.textContent='BUILD 09.07.1';
  ...
  live.src='app-live-points.js?v=2026.09.07.1-live';
  live.async=false;
  live.onload=()=>{
    ...
    append('role-freshness-sync.js?v=2026.09.07.1-role-freshness','role freshness downstream sync');
    accountability();
    ...
    append('release-identity.js?v=2026.09.07.1-release','release-identity helper');
