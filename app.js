/* OTB 2026.08.26.9 — automatic role freshness + downstream projection integrity.
   Preserves the proven 08.26.4/08.26.7 live-core-first startup contract.
   Role freshness is a passive post-core bridge: it never owns startup or xPts
   maths; refreshed Scout evidence flows through the existing role model. */
(function loadOtbProductionLayers(){
  ...
  const badge=document.getElementById('buildBadge');if(badge)badge.textContent='BUILD 08.26.9';
  ...
  live.src='app-live-points.js?v=2026.08.26.9-live';
  live.async=false;
  live.onload=()=>{
    ...
    append('release-identity.js?v=2026.08.26.9-release','release-identity helper');
  };
